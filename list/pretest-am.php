...
$q1 = array(
			'refid'=>'q1',
			'orderno'=> 1,
			'text'=>'A woman can die within ሸሸሸሸሸሸሸ  hours after the onset of postpartum hemorrhage (PPH) if she does not receive proper treatment.',
			'score'=>10,
			'type'=>'select1',
			'r'=>$q1r
			);
...
$q2 = array(
			'refid'=>'q2',
			'orderno'=> 2,
			'text'=>'PPH is the single most important direct cause of maternal death. фывацццку',
			'score'=>10,
			'type'=>'select1',
			'r'=>$q2r
);
...
$json = array (	'refid'=>"PreTestAm",
					'title'=>"PPH Pre Test (Amharic)",
					'maxscore'=>100,
					'q'=>$questions);
